...
public class Team extends Entities
{
    ...
    public Team(String[] line) {
        ...
        wins = 0;
        gamesPlayed = 0;
        fighterList = new ArrayList<>(entityManager.getFPT());
    }
    /**
    ...
    public Game getGame(int round) 
    {
        if (round < 100) {
            ...
            return schedule.get(league.getGameAmt() + round - 100);
        }
    }
    /**
     ...
     * @since 1.0
     */
    public void setNewSchedule(int games) {schedule = new ArrayList<>(games);}
    /**
